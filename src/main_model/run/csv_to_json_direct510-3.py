...
# ======== 常用配置：根据需要修改 ========
INPUT_CSV_PATH = '/home/leizy/24sum/CFRL/data/TH/top_510.csv'
OUTPUT_JSON_DIR = '/home/leizy/24sum/CFRL/data/train_together_datasets/with_prompt_510/3_steps/jsonl_data'
WINDOW_LEN = 24
PRE_LEN = 3
TRAIN_RATIO = 0.7
VAL_RATIO = 0.1
