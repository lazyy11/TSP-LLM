...
# Simple test for the fixed round-robin GPU allocation
# This simulates the main script behavior with simple round-robin

set -e

echo "=========================================="
echo "Testing Simple Fixed Round-Robin GPU Allocation"
echo "=========================================="
...
# Process each task with simple round-robin GPU assignment
current_gpu=0
for i in {1..8}; do
...
echo "Task 7: GPU 2"
echo "Task 8: GPU 3"
echo "Simple fixed allocation test completed successfully!" 